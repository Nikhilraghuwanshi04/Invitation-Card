            ...
            <div className="card-content">
              <div className="couple-photos">
                <div className="photo-container">
                  <img src={groomImage} alt="Groom" className="groom-photo" />
                </div>
                <div className="photo-container">
                  <img src={brideImage} alt="Bride" className="bride-photo" />
                </div>
              </div>

              <div className="hearts-divider">💕</div>

              <h2 className="fs-2 text-primary">राजन & नेहा</h2>
              <h3 className="fs-3 text-secondary mb-4">Rajan & Neha</h3>
              ...
              <div className="venue-details">
                ...
                <p className="mt-2">
                  मांगलिक कार्यक्रम हमारे निवास स्थान रामपुरी में संपन्न होगा।
                </p>
